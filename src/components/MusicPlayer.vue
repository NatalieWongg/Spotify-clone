...
const timeupdate = () => {
    audio.value.addEventListner('timeupdate',function(){
        ...
        var minutes = Math.floor(audio.value.currentTime - minutes * 60);
        isTrackTimeCurrent.value = minutes+':'+defaultServerConditions.toString().padStart(2,'0')
        const value = (100/audio.value.duration) *audio.value.currentTime;
        range.value = valueseeker.value.value = value;
